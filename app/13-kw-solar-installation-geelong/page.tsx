...
export const metadata: Metadata = {
  title: '13 kW Solar Installation Geelong | Easy Solar Solution',
  description: 'Explore 13 kW solar installation in Geelong. Compare system suitability, installation considerations and solar options for your home with Easy Solar Solution.',
  alternates: {
    canonical: '/13-kw-solar-installation-geelong/'
  }
};
    ...
    <div className="min-h-screen bg-background font-[family-name:var(--font-inter)]">
      ...
      <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 bg-primary overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-primary-foreground">
          <nav className="flex items-center justify-center gap-2 text-sm text-primary-foreground/70 mb-6">
            ...
            <span className="text-white">13 kW Solar Installation Geelong</span>
          </nav>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 font-[family-name:var(--font-space-grotesk)]">
            13 kW Solar Installation Geelong
          </h1>
          <p className="text-xl max-w-3xl mx-auto opacity-90">
            Professional 13 kW residential solar solutions for homeowners in Geelong and surrounding suburbs.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 prose prose-lg prose-blue max-w-none">
          ...
          <h2 className="text-3xl font-bold text-[#3e70b5] mt-12 mb-6">13 kW Solar Installation in Geelong</h2>
          <p>Looking for a 13 kW solar installation Geelong? Easy Solar Solution provides residential solar solutions for homeowners in Geelong and surrounding suburbs. A 13 kW system can be considered by households with substantial residential electricity consumption. The right system depends on electricity use, roof space, orientation, shading, equipment selection and future energy plans.</p>
          ...
          <h2 className="text-3xl font-bold text-[#3e70b5] mt-12 mb-6">Is a 13 kW Solar System Right for Your Geelong Home?</h2>
          <p>A 13 kW solar system may suit a Geelong household with substantial residential electricity consumption. It can be particularly relevant where the home uses air conditioning, electric hot water, pool equipment, electric cooking, refrigeration, home-office equipment or an electric vehicle.</p>
          ...
          <h2 className="text-3xl font-bold text-[#3e70b5] mt-12 mb-6">Solar Generation from a 13 kW System in Geelong</h2>
          <p>A 13 kW system's electricity production changes with season, weather, daylight hours, roof orientation, shading, panel performance and system losses. Conditions in Geelong will affect actual generation, so advertised daily figures should be treated as estimates rather than guarantees.</p>
          ...
          <h2 className="text-3xl font-bold text-[#3e70b5] mt-12 mb-6">13 kW Solar System Cost in Geelong</h2>
          <p>The cost of a 13 kW solar installation in Geelong varies according to panel and inverter selection, roof type, accessibility, installation complexity, switchboard requirements, electrical work, grid connection requirements and any additional equipment.</p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold">How much does a 13 kW solar system cost in Geelong?</h3>
            ...
            <div>
              <h3 className="text-xl font-bold">Is a 13 kW system suitable for a home in Geelong?</h3>
          ...
          <div className="mt-16 bg-muted/30 p-8 rounded-2xl border border-border">
            <h2 className="text-2xl font-bold text-[#3e70b5] mb-4">Get a 13 kW Solar Installation Quote in Geelong</h2>
            <p className="mb-6">If you are considering 13 kW solar installation Geelong, Easy Solar Solution can help you understand the system options available for your property. Discuss your electricity usage, roof requirements and future energy plans to determine whether 13 kW is the right fit.</p>
            <p className="mb-8 font-semibold">Contact Easy Solar Solution today to enquire about 13 kW solar installation in Geelong.</p>
